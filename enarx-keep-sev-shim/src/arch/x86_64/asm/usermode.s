...
_usermode:
    ...
    movq    $(1 << 9),%r12    # (1 << 9), # Flags - Set interrupt enable flag

# FIXME: Double fault after this iretq in qemu .. some interrupt is happening
    movq    $0x000,%r12    # disable interrupts for now
###############################################################################
